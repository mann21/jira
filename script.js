...
let ColorArr = ["red-color-btn", "blue-color-btn", "green-color-btn", "yellow-color-btn","black-color-btn"];
...
addBtn.addEventListener("click", function (e) {
    ...
    <div class="filter-area">
        <div class="modal-filter red-color-btn"></div>
        <div class="modal-filter blue-color-btn"></div>
        <div class="modal-filter green-color-btn"></div>
        <div class="modal-filter yellow-color-btn"></div>
